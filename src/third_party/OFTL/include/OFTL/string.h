...
#ifndef OFTL_STRING_H
#define OFTL_STRING_H
...
namespace types
{
    ...
    template<> struct String_Base<char>
    {
         ...
         */
        String_Base& vformat(const char *fmt, va_list ap)
        {
            char *new_buf = NULL;
         ...
         * The format string is the same as with printf family.
         */
        String_Base& vformat(const String_Base& fmt, va_list ap)
        {
            return vformat(fmt.p_buf, ap);
        }
